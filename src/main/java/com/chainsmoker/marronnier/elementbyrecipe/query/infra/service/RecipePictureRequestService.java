...
import com.chainsmoker.marronnier.elementbyrecipe.query.domain.service.PictureRequest;
...
@InfraService
public class RecipePictureRequestService implements PictureRequest {

    private FindPhotoService findPhotoService;

    @Autowired
    public RecipePictureRequestService(FindPhotoService findPhotoService){
